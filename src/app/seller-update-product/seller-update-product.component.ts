...
export class SellerUpdateProductComponent implements OnInit {
  ...
  submit() {
    if (this.updateProductForm.valid && this.productData) { // Check if the form is valid
      const formData: product = { ...this.updateProductForm.value, id: this.productData.id }; // Get form data and set the product ID
